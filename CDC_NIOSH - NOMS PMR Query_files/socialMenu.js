...
function initShareMenu() {
	...
	var menu = '<ul class="dd-menu">';
		if ($(shareContainer).data('twitter') !== false) {
			menu += '<li><a href="#twitter" data-metrics-source="twitter"><img class="twitter" src="'+ imagePath +'twitter-16.png" alt="' + v_twitter + '" \/>' + v_twitter + '<\/a><\/li>';
		}
		if ($(shareContainer).data('facebook') !== false) {
			menu += '<li><a href="#facebook" data-metrics-source="facebook"><img class="facebook" src="'+ imagePath +'facebook-16.png" alt="' + v_facebook + '" \/>' + v_facebook + '<\/a><\/li>';
		}
		if ($(shareContainer).data('pinterest') !== false && v_img !== '') {
			menu += '<li><a href="#pinterest" data-metrics-source="pinterest"><img class="pinterest" src="'+ imagePath +'pinterest-16.png" alt="' + v_pinterest + '" \/>' + v_pinterest + '<\/a><\/li>';
		}
		if ($(shareContainer).data('linkedin') !== false) {
			menu += '<li><a href="#linkedin" data-metrics-source="linkedin"><img class="linkedin" src="'+ imagePath +'linkedin-16.png" alt="' + v_linkedin + '" \/>' + v_linkedin + '<\/a><\/li>';
		}
		if ($(shareContainer).data('email') !== false) {
			menu += '<li><a href="#email" data-metrics-source="email"><img class="email" src="'+ imagePath +'email-16.png" alt="' + v_email + '" \/>' + v_email + '<\/a><\/li>';
		}
		if ($(shareContainer).data('digg') !== false) {
			menu += '<li><a href="#digg" data-metrics-source="digg"><img class="digg" src="'+ imagePath +'digg-16.png" alt="' + v_digg + '" \/>' + v_digg + '<\/a><\/li>';
		}
		if ($(shareContainer).data('syndication') !== false) {
			menu += '<li><a href="https://tools.cdc.gov/medialibrary/index.aspx#/sharecontent/" data-metrics-source="syndication">' + syndicateImage +  v_addthistoyoursite + '<\/a><\/li>';
		}
		menu += '<\/ul>';
...
// Track dragging since it's firing differently in iOS 
$(document).bind('touchstart', function(){ dragging = false; });
$(document).bind('touchmove', function(){ dragging = true; });
